...
data_file = os.path.join(base_dir, "Resultados_simulacion", "OSCILADOR", "EULER-MARUYAMA", filename)
param_file = os.path.join(base_dir, "PARAMETROS", "OSCILADOR", "EULER-MARUYAMA", filename)
output_dir = os.path.join(base_dir, "Graficas", "OSCILADOR", "EULER-MARUYAMA", "TRAYECTORIAS_ENERGIAS")
