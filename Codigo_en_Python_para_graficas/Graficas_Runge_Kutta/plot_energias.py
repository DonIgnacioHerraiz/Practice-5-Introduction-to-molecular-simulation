...
data_file = os.path.join(base_dir, "Resultados_simulacion", "OSCILADOR", "RUNGE-KUTTA", filename)
param_file = os.path.join(base_dir, "PARAMETROS", "OSCILADOR", "RUNGE-KUTTA", filename)
output_dir = os.path.join(base_dir, "Graficas", "OSCILADOR", "RUNGE-KUTTA", "TRAYECTORIAS_ENERGIAS")
